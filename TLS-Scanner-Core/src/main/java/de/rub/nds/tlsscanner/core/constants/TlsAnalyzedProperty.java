...
public enum TlsAnalyzedProperty implements AnalyzedProperty {
    ...
    ACCEPTS_CLIENT_HELLO_CONSECUTIVE_FRAGMENTS(TlsAnalyzedPropertyCategory.DTLS),
    ACCEPTS_CLIENT_HELLO_SUBSEQUENT_FRAGMENTS(TlsAnalyzedPropertyCategory.DTLS),
    ACCEPTS_CLIENT_HELLO_EXTENDED_SUBSEQUENT_FRAGMENTS(TlsAnalyzedPropertyCategory.DTLS),

    ACCEPTS_CLIENT_KEY_EXCHANGE_CONSECUTIVE_FRAGMENTS(TlsAnalyzedPropertyCategory.DTLS),
    ACCEPTS_CLIENT_KEY_EXCHANGE_SUBSEQUENT_FRAGMENTS(TlsAnalyzedPropertyCategory.DTLS),
    ACCEPTS_CLIENT_KEY_EXCHANGE_EXTENDED_SUBSEQUENT_FRAGMENTS(TlsAnalyzedPropertyCategory.DTLS),

    // Version
    CONSECUTIVE_VERSION_TYPE_A_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    CONSECUTIVE_VERSION_TYPE_B_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    SUBSEQUENT_VERSION_TYPE_A_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    SUBSEQUENT_VERSION_TYPE_B_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    EXTENDED_SUBSEQUENT_VERSION_TYPE_A_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    EXTENDED_SUBSEQUENT_VERSION_TYPE_B_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),

    CONSECUTIVE_VERSION_TYPE_A_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    CONSECUTIVE_VERSION_TYPE_B_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    SUBSEQUENT_VERSION_TYPE_A_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    SUBSEQUENT_VERSION_TYPE_B_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    EXTENDED_SUBSEQUENT_VERSION_TYPE_A_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    EXTENDED_SUBSEQUENT_VERSION_TYPE_B_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),

    // CipherSuites
    CONSECUTIVE_CIPHER_SUITES_TYPE_A_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    CONSECUTIVE_CIPHER_SUITES_TYPE_B_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    SUBSEQUENT_CIPHER_SUITES_TYPE_A_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    SUBSEQUENT_CIPHER_SUITES_TYPE_B_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    EXTENDED_SUBSEQUENT_CIPHER_SUITES_TYPE_A_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    EXTENDED_SUBSEQUENT_CIPHER_SUITES_TYPE_B_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),

    CONSECUTIVE_CIPHER_SUITES_TYPE_A_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    CONSECUTIVE_CIPHER_SUITES_TYPE_B_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    SUBSEQUENT_CIPHER_SUITES_TYPE_A_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    SUBSEQUENT_CIPHER_SUITES_TYPE_B_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    EXTENDED_SUBSEQUENT_CIPHER_SUITES_TYPE_A_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    EXTENDED_SUBSEQUENT_CIPHER_SUITES_TYPE_B_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),

    // SignatureAndHashAlgorithms
    CONSECUTIVE_SIG_AND_HASH_TYPE_A_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    CONSECUTIVE_SIG_AND_HASH_TYPE_B_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    SUBSEQUENT_SIG_AND_HASH_TYPE_A_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    SUBSEQUENT_SIG_AND_HASH_TYPE_B_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    EXTENDED_SUBSEQUENT_SIG_AND_HASH_TYPE_A_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    EXTENDED_SUBSEQUENT_SIG_AND_HASH_TYPE_B_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),

    CONSECUTIVE_SIG_AND_HASH_TYPE_A_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    CONSECUTIVE_SIG_AND_HASH_TYPE_B_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    SUBSEQUENT_SIG_AND_HASH_TYPE_A_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    SUBSEQUENT_SIG_AND_HASH_TYPE_B_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    EXTENDED_SUBSEQUENT_SIG_AND_HASH_TYPE_A_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    EXTENDED_SUBSEQUENT_SIG_AND_HASH_TYPE_B_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),

    // ClientKeyExchange
    RSA_CLIENT_KEY_EXCHANGE_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    DH_CLIENT_KEY_EXCHANGE_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    ECDH_CLIENT_KEY_EXCHANGE_ORIGINAL_ORDER(TlsAnalyzedPropertyCategory.DTLS),

    RSA_CLIENT_KEY_EXCHANGE_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    DH_CLIENT_KEY_EXCHANGE_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),
    ECDH_CLIENT_KEY_EXCHANGE_REVERSED_ORDER(TlsAnalyzedPropertyCategory.DTLS),

    REQUIRES_CLIENT_AUTHENTICATION(TlsAnalyzedPropertyCategory.QUIRKS),
    CERTIFICATE_SIGNATURE_AND_HASH_ALGORITHM(TlsAnalyzedPropertyCategory.CERTIFICATE),
    HAS_MULTIPLE_CERTIFICATES(TlsAnalyzedPropertyCategory.CERTIFICATE),
    IGNORES_SIGNATURE_ALGORITHMS_EXTENSION(TlsAnalyzedPropertyCategory.CERTIFICATE),
