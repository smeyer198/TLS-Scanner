...
public enum TlsProbeType implements ProbeType {
    ...
    DTLS_OVERLAPPING_FRAGMENTS("DTLS overlapping fragments"),
    CLIENT_AUTHENTICATION("Client authentication"),
    SIGNATURE_AND_HASH_ALGORITHM_CERTIFICATE("Signature and Hash algorithm in Certificate"),
    IGNORES_SIGNATURE_ALGORITHMS_EXTENSION("Ignore Signature Algorithms Extension"),
